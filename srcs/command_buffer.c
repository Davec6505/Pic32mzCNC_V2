...
command_type_t CommandBuffer_ClassifyToken(const char *token)
{
    ...
    if (first == 'G') {
        ...
        if (sscanf(&token[1], "%d", &code) == 1) {
            switch (code) {
                case 0:  return CMD_G0;
                case 1:  return CMD_G1;
                case 2:  return CMD_G2;
                case 3:  return CMD_G3;
                case 4:  return CMD_G4;
                case 17: return CMD_G17;
                case 18: return CMD_G18;
                case 19: return CMD_G19;
                case 20: return CMD_G20;
                case 21: return CMD_G21;
                case 28: return CMD_G28;
                case 30: return CMD_G30;
                case 90: return CMD_G90;
                case 91: return CMD_G91;
                case 92: return CMD_G92;
        ...
        if (sscanf(&token[1], "%d", &code) == 1) {
            switch (code) {
                case 0:  return CMD_M0;
                case 1:  return CMD_M1;
                case 2:  return CMD_M2;
                case 3:  return CMD_M3;
                case 4:  return CMD_M4;
                case 5:  return CMD_M5;
                case 7:  return CMD_M7;
                case 8:  return CMD_M8;
                case 9:  return CMD_M9;
                case 30: return CMD_M30;
                default: return CMD_UNKNOWN;
            }
        }
    }
