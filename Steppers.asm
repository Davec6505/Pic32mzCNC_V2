...
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Steppers.c,22 :: 		InitTimer8(&delay); //clock delay
SW	R25, 4(SP)
LUI	R25, hi_addr(_delay+0)
ORI	R25, R25, lo_addr(_delay+0)
JAL	_InitTimer8+0
NOP	
;Steppers.c,23 :: 		InitTimer9();       //pulse on time
JAL	_InitTimer9+0
NOP	
;Steppers.c,24 :: 		}
L_end_Init_Steppers:
...
_delay:
;Steppers.c,30 :: 		void delay(){
;Steppers.c,31 :: 		LED2 = false;
_LX	
INS	R2, R0, BitPos(LED2+0), 1
_SX	
;Steppers.c,32 :: 		T9CONSET = 0X8000;
ORI	R2, R0, 32768
SW	R2, Offset(T9CONSET+0)(GP)
;Steppers.c,33 :: 		}
L_end_delay:
JR	RA
NOP	
; end of _delay
__delay_:
;Steppers.c,36 :: 		void _delay_(){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Steppers.c,40 :: 		acc_val = abs((feedrate + drag) / 10);
SW	R25, 4(SP)
...
;Steppers.c,41 :: 		ii = setUsec(0);
MOVZ	R25, R0, R0
JAL	_setUsec+0
NOP	
;Steppers.c,42 :: 		while (getUsec() <= (long)acc_val)continue;
L__delay_0:
JAL	_getUsec+0
NOP	
...
NOP	
L___delay_57:
;Steppers.c,48 :: 		drag = drag - (oil * oil);
...
ADDIU	R2, R2, 1
SH	R2, Offset(Steppers_oil+0)(GP)
;Steppers.c,52 :: 		drag = drag + (oil * oil);
LH	R3, Offset(Steppers_oil+0)(GP)
LH	R2, Offset(Steppers_oil+0)(GP)
MUL	R3, R2, R3
LH	R2, Offset(Steppers_drag+0)(GP)
...
;Steppers.c,55 :: 		if (drag < 0) drag = 0;
LH	R2, Offset(Steppers_drag+0)(GP)
SLTI	R2, R2, 0
...
; end of __delay_
_setStepXY:
;Steppers.c,58 :: 		void setStepXY(int _x1,int _y1,int _x3,int _y3){
;Steppers.c,59 :: 		step.xl = _x1;
SH	R25, Offset(Steppers_step+0)(GP)
;Steppers.c,60 :: 		step.yl = _y1;
SH	R26, Offset(Steppers_step+2)(GP)
;Steppers.c,61 :: 		step.x3 = _x3;
SH	R27, Offset(Steppers_step+8)(GP)
;Steppers.c,62 :: 		step.y3 = _y3;
...
; end of _setStepXY
_setDragOil:
;Steppers.c,65 :: 		void setDragOil(int _feedrate,int _drag,int _oil){
;Steppers.c,66 :: 		feedrate = MAXFEED - _feedrate;
ORI	R2, R0, 180
SUBU	R2, R2, R25
SH	R2, Offset(Steppers_feedrate+0)(GP)
;Steppers.c,67 :: 		drag = _drag;
SH	R26, Offset(Steppers_drag+0)(GP)
;Steppers.c,68 :: 		oil = _oil;
...
L_Steppers_getdir46:
L_Steppers_getdir6:
;Steppers.c,76 :: 		if(f)binrep = binrep + 4;
; binrep start address is: 12 (R3)
...
L_Steppers_getdir47:
L_Steppers_getdir7:
;Steppers.c,77 :: 		if(a)binrep = binrep + 2;
; binrep start address is: 12 (R3)
...
SEH	R4, R3
L_Steppers_getdir8:
;Steppers.c,78 :: 		if(b)binrep = binrep + 1;
...
L_Steppers_getdir49:
L_Steppers_getdir9:
;Steppers.c,80 :: 		switch(binrep){
; binrep start address is: 16 (R4)
J	L_Steppers_getdir10
NOP	
; binrep end address is: 16 (R4)
;Steppers.c,81 :: 		case 0:  step.yo = -1; break;
L_Steppers_getdir12:
ORI	R2, R0, 65535
SH	R2, Offset(Steppers_step+14)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,82 :: 		case 1:  step.xo = -1; break;
L_Steppers_getdir13:
ORI	R2, R0, 65535
SH	R2, Offset(Steppers_step+12)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,83 :: 		case 2:  step.xo = 1;break;
L_Steppers_getdir14:
ORI	R2, R0, 1
SH	R2, Offset(Steppers_step+12)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,84 :: 		case 3:  step.yo = 1; break;
L_Steppers_getdir15:
ORI	R2, R0, 1
SH	R2, Offset(Steppers_step+14)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,85 :: 		case 4:  step.xo = 1;break;
L_Steppers_getdir16:
ORI	R2, R0, 1
SH	R2, Offset(Steppers_step+12)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,86 :: 		case 5:  step.yo = -1;break;
L_Steppers_getdir17:
ORI	R2, R0, 65535
SH	R2, Offset(Steppers_step+14)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,87 :: 		case 6:  step.yo = 1; break;
L_Steppers_getdir18:
ORI	R2, R0, 1
SH	R2, Offset(Steppers_step+14)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,88 :: 		case 7:  step.xo = -1; break;
L_Steppers_getdir19:
ORI	R2, R0, 65535
SH	R2, Offset(Steppers_step+12)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,89 :: 		case 8:  step.xo = -1; break;
L_Steppers_getdir20:
ORI	R2, R0, 65535
SH	R2, Offset(Steppers_step+12)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,90 :: 		case 9:  step.yo = 1;  break;
L_Steppers_getdir21:
ORI	R2, R0, 1
SH	R2, Offset(Steppers_step+14)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,91 :: 		case 10: step.yo = -1;break;
L_Steppers_getdir22:
ORI	R2, R0, 65535
SH	R2, Offset(Steppers_step+14)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,92 :: 		case 11: step.xo = 1;break;
L_Steppers_getdir23:
ORI	R2, R0, 1
SH	R2, Offset(Steppers_step+12)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,93 :: 		case 12: step.yo = 1;break;
L_Steppers_getdir24:
ORI	R2, R0, 1
SH	R2, Offset(Steppers_step+14)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,94 :: 		case 13: step.xo = 1; break;
L_Steppers_getdir25:
ORI	R2, R0, 1
SH	R2, Offset(Steppers_step+12)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,95 :: 		case 14: step.xo = -1; break;
L_Steppers_getdir26:
ORI	R2, R0, 65535
SH	R2, Offset(Steppers_step+12)(GP)
J	L_Steppers_getdir11
NOP	
;Steppers.c,96 :: 		case 15: step.yo = -1; break;
L_Steppers_getdir27:
ORI	R2, R0, 65535
SH	R2, Offset(Steppers_step+14)(GP)
J	L_Steppers_getdir11
...
;Steppers.c,100 :: 		static void setdirection(){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Steppers.c,102 :: 		step.dy = step.y3 - step.yl;
SW	R25, 4(SP)
LH	R3, Offset(Steppers_step+2)(GP)
LH	R2, Offset(Steppers_step+10)(GP)
SUBU	R2, R2, R3
SH	R2, Offset(Steppers_step+18)(GP)
;Steppers.c,103 :: 		if(step.dy < 0) step.yo = -1;
...
;Steppers.c,109 :: 		else step.xo = 1;
ORI	R2, R0, 1
SH	R2, Offset(Steppers_step+12)(GP)
L_Steppers_setdirection31:
;Steppers.c,110 :: 		step.dx = abs(step.dx);
LH	R25, Offset(Steppers_step+16)(GP)
JAL	_abs+0
NOP	
SH	R2, Offset(Steppers_step+16)(GP)
;Steppers.c,112 :: 		if(step.dx>step.dy){step.fxy = step.dx - step.dy;step.fm=0;}
...
;Steppers.c,113 :: 		else {step.fxy = step.dy - step.dx; step.fm=1;}
...
_doline:
;Steppers.c,116 :: 		void doline(){
ADDIU	SP, SP, -44
SW	RA, 0(SP)
;Steppers.c,117 :: 		step.stepnum = step.x2 = step.y2 = step.fxy = 0;
SW	R25, 4(SP)
...
;Steppers.c,118 :: 		setdirection();
JAL	Steppers_setdirection+0
NOP	
;Steppers.c,119 :: 		while(DMA_IsOn(1));
L_doline34:
ORI	R25, R0, 1
JAL	_DMA_IsOn+0
NOP	
...
NOP	
ADDIU	SP, SP, 8
;Steppers.c,121 :: 		while ( (step.dx > step.x2) && (step.dy > step.y2)){ // at endpoint?
L_doline36:
...
L__doline111:
L__doline50:
;Steppers.c,122 :: 		_delay_();
JAL	__delay_+0
NOP	
;Steppers.c,124 :: 		out = 0;
SH	R0, Offset(_out+0)(GP)
;Steppers.c,125 :: 		if(!step.fm){
...
NOP	
L__doline113:
;Steppers.c,129 :: 		++step.y2; step.fxy += step.dx;
LH	R2, Offset(Steppers_step+6)(GP)
ADDIU	R2, R2, 1
SH	R2, Offset(Steppers_step+6)(GP)
LH	R3, Offset(Steppers_step+16)(GP)
...
ADDU	R2, R2, R3
SH	R2, Offset(Steppers_step+22)(GP)
;Steppers.c,130 :: 		bit_true(out,bit(1));
LHU	R2, Offset(_out+0)(GP)
ORI	R2, R2, 2
SH	R2, Offset(_out+0)(GP)
;Steppers.c,131 :: 		}
...
NOP	
L_doline40:
;Steppers.c,133 :: 		++step.y2; step.fxy -= step.dx;
LH	R2, Offset(Steppers_step+6)(GP)
ADDIU	R2, R2, 1
SH	R2, Offset(Steppers_step+6)(GP)
LH	R3, Offset(Steppers_step+16)(GP)
...
SUBU	R2, R2, R3
SH	R2, Offset(Steppers_step+22)(GP)
;Steppers.c,134 :: 		bit_true(out,bit(1));
LHU	R2, Offset(_out+0)(GP)
ORI	R2, R2, 2
SH	R2, Offset(_out+0)(GP)
;Steppers.c,135 :: 		if(step.fxy < 0){
LH	R2, Offset(Steppers_step+22)(GP)
SLTI	R2, R2, 0
...
NOP	
L__doline114:
;Steppers.c,136 :: 		++step.x2;step.fxy += step.dy;
LH	R2, Offset(Steppers_step+4)(GP)
ADDIU	R2, R2, 1
SH	R2, Offset(Steppers_step+4)(GP)
LH	R3, Offset(Steppers_step+18)(GP)
...
ADDU	R2, R2, R3
SH	R2, Offset(Steppers_step+22)(GP)
;Steppers.c,137 :: 		bit_true(out,bit(0));
LHU	R2, Offset(_out+0)(GP)
ORI	R2, R2, 1
SH	R2, Offset(_out+0)(GP)
;Steppers.c,138 :: 		}
...
;Steppers.c,139 :: 		}
L_doline42:
;Steppers.c,140 :: 		while(DMA_IsOn(1));
L_doline44:
ORI	R25, R0, 1
JAL	_DMA_IsOn+0
NOP	
...
NOP	
ADDIU	R3, SP, 11
;Steppers.c,143 :: 		step.y2,step.xo,step.yo,out,acc_val,drag,oil);
LH	R2, Offset(Steppers_oil+0)(GP)
ADDIU	SP, SP, -44
SH	R2, 40(SP)
LH	R2, Offset(Steppers_drag+0)(GP)
...
LH	R2, Offset(Steppers_step+6)(GP)
SH	R2, 16(SP)
;Steppers.c,142 :: 		,step.stepnum++,step.fxy,step.x2,
LH	R2, Offset(Steppers_step+4)(GP)
SH	R2, 12(SP)
LH	R2, Offset(Steppers_step+22)(GP)
SH	R2, 8(SP)
